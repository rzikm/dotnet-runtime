...
internal static partial class Interop
{
    internal static partial class Crypto
    {
        ...
        [DllImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_ErrGetExceptionError")]
        private static extern ulong ErrGetExceptionError([MarshalAs(UnmanagedType.Bool)] out bool isAllocFailure);
