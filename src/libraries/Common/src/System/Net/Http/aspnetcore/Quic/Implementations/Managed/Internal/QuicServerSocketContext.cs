...
namespace System.Net.Quic.Implementations.Managed.Internal
{
    ...
    //         var endpoint = new IPEndPoint(connection.RemoteEndPoint.Address, connection.LocalEndPoint.Port);
    //         var newContext = new SingleConnectionSocketContext(endpoint, connection.RemoteEndPoint, connection);
    //
    //         // context is created, all network traffic is redirected, now we need to drain all packets we may have
