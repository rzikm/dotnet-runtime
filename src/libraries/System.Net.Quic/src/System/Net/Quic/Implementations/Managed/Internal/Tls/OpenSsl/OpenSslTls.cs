...
#pragma warning restore CA1810
                ...
                options.ServerAuthenticationOptions?.CipherSuitesPolicy)
        {
            ...
            {
                throw new ArgumentNullException(nameof(options.ServerAuthenticationOptions));
            }
        ...
        {
#if LINUX
            // Linux uses OpenSSL backend, we can pass the certificate handle directly
            Interop.OpenSslQuic.SslUseCertificate(_ssl, serverCertificate.Handle);
#else
